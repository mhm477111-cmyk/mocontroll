export const metadata = {
  title: 'MO CONTROL | شحن باقات إميرالد، فودافون ريد، ووي جولد',
  description: 'اشحن باقات إميرالد اتصالات، فودافون ريد، ووي جولد في ثوانٍ. خدمة MO CONTROL توفر لك شحن باقات النت والدقائق وتجديد الاشتراكات بأسرع وقت وأقل مجهود.',
  keywords: [
    'MO CONTROL', 'مو كنترول', 'شحن باقة اميرالد', 'اتصالات اميرالد', 
    'فودافون ريد', 'وي جولد', 'We Gold', 'شحن باقات نت', 
    'تجديد باقة اتصالات', 'شحن دقائق فودافون', 'خدمات دفع رقمي'
  ],
  openGraph: {
    title: 'MO CONTROL - متخصصون في شحن باقات الـ VIP والنت',
    description: 'تجديد فوري لباقات إميرالد، فودافون ريد، ووي جولد. شحن نت ودقائق لكل الشبكات.',
    url: 'https://mo-control.vercel.app',
    siteName: 'MO CONTROL',
    locale: 'ar_EG',
    type: 'website',
  },
